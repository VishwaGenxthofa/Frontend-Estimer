    ...
    builder
      ...
      .addCase(createEstimate.fulfilled, (state, action) => {
        ...
        state.estimates.push({
          ...
          statusColor:newEst.statusColor,
          versionNumber: newEst.versionNumber,
          estimationStatusId: newEst.statusId,
          finalAmount:newEst.finalAmount,
          profitPercentage: newEst.profitPercentage,
          estimationStatusId:newEst.estimationStatusId,
          statusName:newEst.statusName,
         totalLaborCost:newEst.totalLaborCost,
        totalDirectCost:newEst.totalDirectCost,
    totalIndirectCost:newEst.totalIndirectCost,
    totalAdditionalCost:newEst.totalAdditionalCost,
    subTotal:newEst.subTotal,
    profitAmount:newEst.profitAmount,
    taxId:newEst.taxId,
    taxName:newEst.taxName,
    taxPercentage:newEst.taxPercentage,
