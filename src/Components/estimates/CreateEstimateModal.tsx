...
// import { createEstimate } from '../../redux/estimateSlice';
...
//   const calcTotal = () => {
//     const projTeam = projects.filter(tm => tm.projectId === parseInt(selectedProject));
...
//     const version = estimates.filter(e => e.projectId === parseInt(selectedProject)).length + 1;

//     setEstimates(prev => [...prev, {
//       estimateId: estimates.length + 1,
