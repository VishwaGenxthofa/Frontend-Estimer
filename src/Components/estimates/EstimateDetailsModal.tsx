...
//             </div>
//           ))}
//           <div className="font-bold border-t pt-2">Total: ₹{estimate.laborCosts.toFixed(2)}</div>
//         </div>
...
//             <div className="flex justify-between"><span>Profit ({estimate.profitPercentage}%):</span><span className="text-green-600">₹{estimate.profitAmount.toFixed(2)}</span></div>
//             <div className="flex justify-between"><span>Tax ({estimate.taxPercentage}%):</span><span className="text-blue-600">₹{estimate.taxAmount.toFixed(2)}</span></div>
//             <div className="flex justify-between font-bold text-2xl border-t-2 pt-3">
//               <span>Final Amount:</span>
//               <span className="text-blue-600">₹{estimate.finalAmount.toFixed(2)}</span>
//             </div>
//           </div>
//         </div>
//       </div>
