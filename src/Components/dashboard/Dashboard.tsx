...
import Logo from "../../assets/estimer-icon.png";
...
useEffect(()=>{
  ...
  return (
    <div>
      ...
      <motion.img
        src={Logo}
        className="w-13 h-13 text-pink-600"
        animate={{
          scale: [0.8, 1, 0.8],
          rotate: [0, 5, -5, 0],
        }}
      ...
      <h2 className="text-3xl font-bold text-gray-800 mb-8"><AuroraText> Dashboard </AuroraText></h2>
